            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <button 
                  type="submit" 
                  disabled={submitting}
                  className={`w-full py-3 px-4 rounded-md focus:outline-none focus:ring-2 font-medium ${isCashWithdrawal ? 'bg-amber-600 hover:bg-amber-700 focus:ring-amber-500' : 'bg-blue-600 hover:bg-blue-700 focus:ring-blue-500'} text-white disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center`}
                >
                  {submitting ? (
                    <>
