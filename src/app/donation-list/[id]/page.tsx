  ...
  const fetchDonation = async () => {
    try {
      ...
      if (snap.exists()) {
        ...
        setEditReferredBy(donationItem.referredBy || "");
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input type="text" value={editReferredBy} onChange={e => setEditReferredBy(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter referrer name (optional)" />
                </div>
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {donation.referredBy && (
                        <div>
                          ...
                          <p className="text-base font-medium text-gray-900">{donation.referredBy}</p>
                        </div>
                      )}
                      <div>
